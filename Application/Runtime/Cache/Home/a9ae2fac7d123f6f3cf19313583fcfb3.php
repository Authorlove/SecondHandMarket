			...
			<div class="thumbnail">
				...
				<div class="caption my-text">
					...
					<div class="row">
						...
						<div class="col-md-6 col-xs-6">
							<?php echo (substr($vo["update_time"],0,10)); ?>
						</div>
						<hr>
						<div class="col-md-12 col-xs-12">
							<a href="<?php echo U('Index/detail').'?gid='.$vo['gid'];?>" class="btn btn-primary btn-sm">查看详情</a>
							<?php switch($vo["status"]): case "0": ?><a href="<?php echo U('User/delete').'?gid='.$vo['gid'];?>" type="button" class="btn btn-danger btn-sm">下架</a><?php break; endswitch;?> 							
						</div>
					</div>
				</div>
			</div>
