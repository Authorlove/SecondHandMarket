...
<body>
	...
	<ul class="nav navbar-nav">
		...
		<li class="active"><a href="<?php echo U('User/publish');?>">发布 <span class="glyphicon glyphicon-plus" aria-hidden="true"></span></a></li>
		<li class="dropdown">
	...
	<div class="row">
		<form action="<?php echo U('User/submitPublish');?>" enctype="multipart/form-data" method="POST" class="form-horizontal" role="form">
				<div class="form-group">
