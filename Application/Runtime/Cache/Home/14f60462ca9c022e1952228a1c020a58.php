...
<body>
	...
	<div class="row">
		<div class="panel panel-default">
			  <div class="panel-heading">
					<h3 class="panel-title">修改账号或用户名</h3>
			  </div>
			  <div class="panel-body">
					<form action="<?php echo U('User/submitSetting');?>" enctype="multipart/form-data" method="POST" class="form-horizontal" role="form">
					  		<div class="form-group">
					  			<input type="hidden" name="uid" value="<?php echo ($uid); ?>">
					  			<label for="uaccount" class="col-md-2 control-label">账号</label>
					  			<div class="col-md-8">
				  					<input type="email" name="uaccount" id="uaccount" class="form-control" required="required" placeholder="请输入邮箱" value="<?php echo ($uaccount); ?>">
					  			</div>
			  				</div>
			  				<div class="form-group">
					  			<label for="uname" class="col-md-2 control-label">用户名</label>
					  			<div class="col-md-8">
				  					<input type="text" name="uname" id="uname" class="form-control" required="required" placeholder="请输入用户名" value="<?php echo ($uname); ?>">
					  			</div>
			  				</div>
							<div class="form-group">
		...
		<div class="panel panel-default">
			  ...
			  <div class="panel-body">
					<form action="<?php echo U('User/submitSetting');?>" enctype="multipart/form-data" method="POST" class="form-horizontal" role="form">
				  			<input type="hidden" name="uid" value="<?php echo ($uid); ?>">
			  				<div class="form-group">
					  			<label for="password" class="col-md-2 control-label">输入原密码</label>
					  			<div class="col-md-8">
				  					<input type="password" name="password" id="password" class="form-control" required="required" placeholder="请输入密码">
					  			</div>
			  				</div>
			  				<div class="form-group">
					  			<label for="upwd" class="col-md-2 control-label">输入新密码</label>
					  			<div class="col-md-8">
				  					<input type="password" id="upwd" class="form-control" required="required" placeholder="">
					  			</div>
			  				</div>
							<div class="form-group">
								<div class="col-sm-10 col-sm-offset-2">
	...
	<div class="row">
		<div class="panel panel-default">
			  ...
			  <div class="panel-body">
					<form action="<?php echo U('User/updatePic');?>" enctype="multipart/form-data" method="POST" class="form-horizontal" role="form">
				  			<input type="hidden" name="uid" value="<?php echo ($uid); ?>">
			  				<div class="form-group">
					  			...
					  			<div class="col-md-2">
					  				<img id="uploadPreview" class="img-responsive" src="<?php echo ($upic); ?>" /> 
					  			</div>
					  		</div>
							<div class="form-group">
								<div class="col-sm-10 col-sm-offset-2">
